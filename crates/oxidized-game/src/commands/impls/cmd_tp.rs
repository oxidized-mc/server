...
fn exec_tp_location(_ctx: &CommandContext<CommandSourceStack>) -> Result<i32, CommandError> {
    // TODO: Send ClientboundPlayerPositionPacket to move the source player.
    Err(CommandError::NotImplemented("tp".into()))
}

/// `/tp <destination>` — teleport source to entity.
fn exec_tp_destination(_ctx: &CommandContext<CommandSourceStack>) -> Result<i32, CommandError> {
    // TODO: Look up destination entity position, then teleport source.
    Err(CommandError::NotImplemented("tp".into()))
}
...
fn exec_tp_targets_destination(
    ...
    // TODO: Look up destination entity, then teleport all targets to it.
    Err(CommandError::NotImplemented("tp".into()))
}
